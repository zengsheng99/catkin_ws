...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_interactive_markers_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/turtlebot_interactions/turtlebot_interactive_markers)
  set(turtlebot_interactive_markers_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(turtlebot_interactive_markers_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_interactive_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/turtlebot_interactions/turtlebot_interactive_markers/${idir}'.  ${_report}")
    endif()
