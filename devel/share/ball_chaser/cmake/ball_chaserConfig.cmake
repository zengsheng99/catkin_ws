...
if(NOT "/home/vboxuser/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vboxuser/catkin_ws/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;std_msgs;message_runtime;sensor_msgs")
