...
if("TRUE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/slam_gmapping/gmapping)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/slam_gmapping/gmapping/${idir}'.  ${_report}")
    endif()
