...
if("TRUE" STREQUAL "TRUE")
  set(add_markers_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/add_markers)
  set(add_markers_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel)
  ...
  set(add_markers_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'add_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/add_markers/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(add_markers_EXPORTED_TARGETS ${${add_markers_dep}_EXPORTED_TARGETS})
endforeach()
